...
<div class="album py-5 bg-transparent">
    <div class="container">
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        <div class="col animate__animated animation-fill-mode: forwards; animate__fadeInTopLeft animate__delay-1.5s">
        ...
        <div class="col animate__animated animate__fadeInTopLeft animate__delay-2s">
          <div class="card shadow-sm">
        ...
        <div class="col animate__animated animate__fadeInTopLeft animate__delay-2.5s">
          <div class="card shadow-sm">
